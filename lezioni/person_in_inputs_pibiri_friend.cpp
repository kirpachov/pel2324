...
struct Person {
    ...
    /*
      Giulio: puoi ottenere lo stesso effetto
      usando la keyword "friend".
      Questo lo si potrebbe preferire stilisticamente
      alla scelta di avere il sovraccarico esterno alla
      classe Person
      perchè stai "raggruppando" tutto il codice per Person
...
//     os << "(name:" << p.fullname << "|age:" << p.age << "|weight:" <<
//     p.weight
//        << ")";
//     return os;
// }
